...
class SFTDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        self.prompts = self.dataframe[self.prompt_key] if len(self.prompt_key) > 1 or self.prompt_dict_keys else self.dataframe[self.prompt_key[0]]
        ...
        self.responses = self.dataframe[self.response_key] if len(self.response_key) > 1 or self.response_dict_keys else self.dataframe[self.response_key[0]]
